/**
 * Bump this whenever you ship a change, so you can tell at a glance which build
 * is live. Shows in the bottom-right corner at very low opacity — visible if
 * you're looking for it, invisible if you're not. Hover to read it clearly.
 *
